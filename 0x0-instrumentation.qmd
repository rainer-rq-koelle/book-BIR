...
NOTE: flight club video



PUD                      SUC
P - Pitot blocked         S - static blocked
U - Under-reads           U - Under-read
D - in Descent            C - in Climb

```{r}
knitr::include_graphics("./figures/inst-ASI-POC-PUD.png")
knitr::include_graphics("./figures/inst-ASI-SUC-SOD.png")
```
...
```{r}
knitr::include_graphics("./figures/inst-indicated-vs-true-altitude.jpg")
```
...
CHECK ALSO: https://wiki.ivao.aero/en/home/training/documentation/Navigation_Display_-_ND for figures, etc.
...
* no North Arrow indicator (PLAN!)
* (triangular) aircraft symbol
...
FMS databases    
+ navigation database ~ read-only, but amendable; 28-days AIRAC cycle
+ performance database ~ read-only, when required -> ac parameters

FMS components:   
+ Control and Display Unit (Captain and FO)
+ FMC (redundant) - with databases
+ control panel

```{r}
#| label: fig-inst-FMS

knitr::include_graphics("./figures/inst-FMS.png")
```
...
AIBus nd video https://www.youtube.com/watch?v=F6wBh8WF0x8
ND - MAP: https://www.bing.com/videos/riverview/relatedvideo?q=ATPL+ND+MAP+mode&cvid=78babbb48f814625982e1c5c12cae39a&gs_lcrp=EgRlZGdlKgYIABBFGDkyBggAEEUYOTIGCAEQABhA0gEJMTQ0NjBqMGoxqAIAsAIA&PC=U531&ru=%2fsearch%3fq%3dATPL%2bND%2bMAP%2bmode%26cvid%3d78babbb48f814625982e1c5c12cae39a%26gs_lcrp%3dEgRlZGdlKgYIABBFGDkyBggAEEUYOTIGCAEQABhA0gEJMTQ0NjBqMGoxqAIAsAIA%26FORM%3dANAB01%26PC%3dU531&mmscn=vwrc&mid=E0E99C92DF96C2C74212E0E99C92DF96C2C74212&FORM=WRVORC&ntb=1&msockid=0d0dbb477f2111f0be5b8bd3b0f6a311
https://www.brainscape.com/flashcards/remote-indicating-compass-17236226/packs/22420401
https://wiki.ivao.aero/en/home/training/documentation/Flight_Management_System_-_FMS


https://www.studyaircrafts.com/systems

rate of turn $\text{rate of turn}=\frac{g * tan(\text{bank angle})}{TAS}$   
rate of turn    
- directly proportional to bank angle (tan(bankangle))
- inversely proportional to TSA $RoT ~ \frac{1}{TAS}$
- indeptendet of aircraft weight

Gyro and axes
TL1 AV2 DH2 PYR
TL1 - turn indicator - ac lateral axis ~ pitch (horizontal) - 1 degree of freedom
AV2 - artificial horizon - vertical axis ~ yaw - 2 deg
DH2 - directional gyro - horizontal axis ~ roll? - 2 deg
PYR?


ball and needle to one side == NOT ENOUGH RUDDER == TOO MUCH BANK    
thus correct the ball   
* kick the ball --> more rudder
* wingtip low   --> less bank

ball opposite to needle
* too little bank --> more bank
* excessive rudder --> less rudder

slipping turn ~ ball and needle in the direction of turn
skidding turn ~ needle in turn direction, ball deflected opposite

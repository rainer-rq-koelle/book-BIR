...
Operating systems are termed 'multi-tasking' as they allow more than one programme to run at the same time.    
Not to be confused with 'multi-processing' ~ more than one processor (2 or more CPUs) are used to operate a single computer programme.
